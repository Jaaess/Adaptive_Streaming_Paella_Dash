...
Class ("paella.MpegDashVideo", paella.Html5Video,{
					...
					.then(function() {
						...
						player.on(dashjs.MediaPlayer.events.STREAM_INITIALIZED,function(a,b) {
							...
							This._deferredAction(function() {
								...
								//TODO: Here was a Probleme with resolvve()
								resolve();
							});
						});
					});
	...
	setQuality:function(index) {
		...
		console.debug("Test test test set Quality")
		return new Promise((resolve,reject) => {
			...
			if (index==this.autoQualityIndex) {
				...
				// TODO: this function should be verified: anscheinend ist abhängig von der ver Verwaltung von Qualitätstufen.
